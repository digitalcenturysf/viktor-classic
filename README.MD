# Viktor Classic v1.0.0
![Viktor Classic - Free Wordpress Theme](/screenshot.png)
...
* **Support Forum** : https://wordpress.org/support/theme/viktor-clasic
...
1. Via The WordPress Dashboard (Easier):   
	...
	c) Click on the Browse button and find the viktor-classic.zip file  and then click on the "Install" button.    
...
2. Via FTP:  
	* Unzip the package you downloaded, inside you will find a file called viktor-classic.zip   
	* Login to your web server via FTP and browse to wp-content/themes and upload the viktor-classic folder here    
...
Viktor Classic WordPress Theme, Copyright (C) 2018, DigitalCenturySF
Viktor Classic is distributed under the terms of the GNU GPL
...
## Theme License
The **Viktor Classic WordPress theme** is 100% GPLv2. See headers of files for further details.[GNU GPL v2.0 or later](http://www.gnu.org/licenses/gpl-2.0.html)
