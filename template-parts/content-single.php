...
?>
 ...
 <div class="news-featured-image">
     <a href="#"><?php the_post_thumbnail('viktor-classic-single-blog'); ?></a>
     <div class="date-area">
         <ul>
 ...
 <div class="single-blog-content">
     <?php the_content(); 
      wp_link_pages( array(
        'before' => '<div class="page-links">' . esc_html__( 'Pages:','viktor-classic' ),
        'after'  => '</div>',
      ) ); 
     ?>   
      <?php  
      global $numpages;
        if ( is_singular( 'attachment' ) ) {
          ...
          the_post_navigation( array(
            'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link','viktor-classic' ),
          ) );
  ...
  <div class="row content-info">
       <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
           <div class="blog-content-tag">
               <ul class="ptags">
                   <li> <span><?php esc_html_e('Tags','viktor-classic'); ?>: </span> </li>
...
<?php
 ...
 if($viktor_lite_authordesc): ?>
  <div class="row author-post">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="about-author-post">
              <h2><?php esc_html_e('About Post Author','viktor-classic'); ?></h2>
